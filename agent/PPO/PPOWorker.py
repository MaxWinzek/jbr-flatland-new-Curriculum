...
@ray.remote
class PPOWorker():
    def __init__(self, worker_handle, env_config, controller_config, curriculum_manager=None):
        self.worker_handle = worker_handle
        self.env = env_config.create_env(curriculum_manager=curriculum_manager)
